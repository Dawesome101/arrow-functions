...
const newJoe = () => new Student('Dan', 'Schmoe', 100);
...
Student.prototype.newGreeting = () => `Hi, my name is ${newJoe().name}`;
...
// The window object (globally scoped).

// 3. Explain why "this" is different when an arrow function is used.
//  Arrow functions don't have their own 'this'.  The value of 'this' remains the same throughout the lifecycle of the function and is always bount to the value of 'this' in the closest non-arrow parent function.